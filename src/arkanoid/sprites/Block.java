...
public class Block implements Collidable, Sprite, HitNotifier {
     ...
     *
     * @param gameLevel the game level to add the block to
     */
    ...
    //  removeFromGame(GameLevel) method that removes the block from the game
    /**
     * Remove the block from the game.
     *
     * @param gameLevel the game level to remove the block from
     */
