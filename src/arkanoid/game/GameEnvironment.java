 ...
 * The GameEnvironment class is Java collection of such things.
...
public class GameEnvironment {
     ...
     * Get the collidables collection.
     *
     * @return an unmodifiable view of the collidables collection
     */
    public List<Collidable> getCollidables() {
        return java.util.Collections.unmodifiableList(this.collidables);
    }
