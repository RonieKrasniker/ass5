...
public class Rectangle {
    ...
    private final Line[] cachedLines; // Cached lines for performance
    ...
    /**
     * Compute the lines of the rectangle (called once in constructor).
     *
     * @return an array of the lines of the rectangle
     */
    private Line[] computeLines() {
        ...
        lines[0] = new Line(this.upperLeft, upperRight); // top
        lines[1] = new Line(bottomLeft, bottomRight); // bottom
        lines[2] = new Line(this.upperLeft, bottomLeft); // left
        lines[3] = new Line(upperRight, bottomRight); // right
        return lines;
    }
    ...
    /**
     * @return an array of the lines of the rectangle (cached)
     */
    ...
    //Note: setUpperLeft removed since Point is immutable
    //To change rectangle position, create a new Rectangle instance
